...
function showSection(section) {
  ...
  if (section === 'requirements') {
    fetch(`https://eventforge.onrender.com/api/requirements/${club}?event=${encodeURIComponent(event)}`)
    ...
    fetch(`https://eventforge.onrender.com/api/posters/${club}?event=${encodeURIComponent(event)}`)
      .then(response => response.json())
      .then(data => {
        if (data.error) {
    ...
    fetch(`https://eventforge.onrender.com/api/sponsors/${club}?event=${encodeURIComponent(event)}`)
      .then(response => response.json())
      .then(data => {
        content.innerHTML = `
    ...
    fetch(`https://eventforge.onrender.com/api/purchase/${club}?event=${encodeURIComponent(event)}`)
      .then(response => response.json())
      .then(data => {
        content.innerHTML = `
