document.addEventListener('DOMContentLoaded', async () => {
    try {
      const response = await fetch('https://eventforge.onrender.com/clubs');
  ...
  async function fetchAndDisplayEvents(clubName) {
    try {
      const response = await fetch(`https://eventforge.onrender.com/events/${encodeURIComponent(clubName)}`);
