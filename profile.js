...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch(`https://eventforge.onrender.com/api/events?clubName=${encodeURIComponent(clubName)}`)
      .then(res => res.json())
      .then(data => {
    ...
    if (submitEventBtn) {
      submitEventBtn.addEventListener("click", () => {
        ...
        fetch('https://eventforge.onrender.com/api/submit-events', {
          method: 'POST',
          headers: {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch(`https://eventforge.onrender.com/api/uds?clubName=${encodeURIComponent(clubName)}`)
      .then(res => res.json())
      .then(data => {
    ...
    if (submitUDSBtn) {
      submitUDSBtn.addEventListener("click", () => {
        ...
        fetch('https://eventforge.onrender.com/api/submit-uds', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch(`https://eventforge.onrender.com/api/housekeeping?clubName=${encodeURIComponent(clubName)}`)
      .then(res => res.json())
      .then(data => {
    ...
    document.querySelector(".submitHousekeepingBtn").addEventListener("click", () => {
      ...
      fetch("https://eventforge.onrender.com/api/submit-housekeeping", {
        method: "POST",
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Fetch Wi-Fi Table
    fetch(`https://eventforge.onrender.com/api/wifi?clubName=${encodeURIComponent(clubName)}`)
      .then(res => res.json())
      .then(data => {
    ...
    document.querySelector(".submitWifiBtn").addEventListener("click", () => {
      ...
      fetch("https://eventforge.onrender.com/api/submit-wifi", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    // Fetch Sponsors
    fetch(`https://eventforge.onrender.com/api/sponsors?clubName=${encodeURIComponent(clubName)}`)
      .then(res => res.json())
      .then(data => {
    ...
    document.querySelector(".submitSponsorsBtn").addEventListener("click", () => {
      ...
      fetch("https://eventforge.onrender.com/api/submit-sponsors", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    // Fetch Posters
    fetch(`https://eventforge.onrender.com/api/posters?clubName=${encodeURIComponent(clubName)}`)
      .then(res => res.json())
      .then(data => {
    ...
    document.querySelector(".submitPostersBtn").addEventListener("click", () => {
      ...
      fetch("https://eventforge.onrender.com/api/submit-posters", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    // Fetch Purchase Data
    fetch(`https://eventforge.onrender.com/api/purchases?clubName=${encodeURIComponent(clubName)}`)
      .then(res => res.json())
      .then(data => {
    ...
    document.querySelector(".submitPurchaseBtn").addEventListener("click", () => {
      ...
      fetch("https://eventforge.onrender.com/api/submit-purchases", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
